...
const commands = {
     ...
     * We could assign variables with the same name as the commands below.
     * @default object
     */
    audio: {
        f: () => {
    ...
    cat: {
        f: (command) => {
            const cat = command?.match(/^cat\s+(.+)$/) || ["cat", "."]; // Nano
            if (self.pyodide) {
    ...
    gen: {
        f: () => {
            if (self.pyodide) {
                ...
                jU35geihUYHR1fmAoPm1gIj1pYHcyPWBwaD9gQ1R2YDJYaWB5YX5geXFHYCI8d2BwR2BgdC9pYHVeaWB5YX5geXFHYHYlaWBwKX5gfGR+YHlhfmAgZn5gcF59MG0=`.trim(); // XSS sanat
    ...
    lipsum: {
        f: () => {
            const lorem = ["Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
                ...
                "Taboire de verrat d'estique de patente à gosse de torrieux de maudine d'ostie de câline de bine de cibole de saint-sacrament de bâtard de rigodon de crisse de boswell de cossin de crucifix."];
